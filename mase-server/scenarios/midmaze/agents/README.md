...
This scenario owns the DFS sample agent source for MidMaze:
[SampleDfsAgentBob.java](src/main/java/org/maze/scenarios/midmaze/agents/SampleDfsAgentBob.java).
