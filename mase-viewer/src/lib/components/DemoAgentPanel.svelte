            ...
            <div>
                ...
                <div class="rounded border bg-gray-950 p-2 text-xs text-gray-100">
                    ...
                    {#if demoState.transcript.requestBody}
                        <pre class="mt-2 max-h-32 overflow-auto whitespace-pre-wrap border-t border-gray-700 pt-2">{demoState.transcript.requestBody}</pre>
                    {/if}
                </div>
            </div>
            <div>
                ...
                <div class="rounded border bg-gray-950 p-2 text-xs text-gray-100">
                    ...
                    {#if demoState.transcript.responseBody}
                        <pre class="mt-2 max-h-40 overflow-auto whitespace-pre-wrap border-t border-gray-700 pt-2">{demoState.transcript.responseBody}</pre>
                    {:else}
